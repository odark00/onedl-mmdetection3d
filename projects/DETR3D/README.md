...
1. Download the newly trained weights accordingly.
   ...
   | :-----------------------------------------------------------------------------------------------------: | :--: | :--: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
   |          [DETR3D, ResNet101 w/ DCN, evaluation on val set](./configs/detr3d_r101_gridmask.py)           | 35.5 | 42.8 |                 [model](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_r101_gridmask.pth) \| [log](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_r101_gridmask.log)                 |
   |             [above, + CBGS, evaluation on val set](./configs/detr3d_r101_gridmask_cbgs.py)              | 35.2 | 42.7 |            [model](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_r101_gridmask_cbgs.pth) \| [log](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_r101_gridmask_cbgs.log)            |
   | [DETR3D, VoVNet on trainval, evaluation on test set](./configs/detr3d_vovnet_gridmask_trainval_cbgs.py) | 41.4 | 48.1 | [model](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_vovnet_gridmask_trainval_cbgs.pth) \| [log](https://mmassets.onedl.ai/mmdetection3d/v1.1.0_models/detr3d/detr3d_vovnet_gridmask_trainval_cbgs.log) |
