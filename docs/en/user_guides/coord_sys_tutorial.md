...
The raw annotation of KITTI is under camera coordinate system, see [get_label_anno](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/tools/dataset_converters/kitti_data_utils.py). In MMDetection3D, to train LiDAR-based models on KITTI, the data is first converted from camera coordinate system to LiDAR coordinate system, see [get_ann_info](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/mmdet3d/datasets/kitti_dataset.py). For training vision-based models, the data is kept in the camera coordinate system.
...
For the conversion from raw annotation to annotation under our Depth coordinate system, please refer to [sunrgbd_data_utils.py](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/tools/dataset_converters/sunrgbd_data_utils.py).
...
See the code [here](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/mmdet3d/core/bbox/structures/box_3d_mode.py) for more details.
...
See the code [here](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/mmdet3d/core/bbox/structures/cam_box3d.py) for more details.
...
No. For example, [RoI-Aware Pooling ops](https://github.com/vbti-development/onedl-mmcv/blob/master/mmcv/ops/roiaware_pool3d.py) is applicable to boxes under Depth or LiDAR coordinate system only. The evaluation functions for KITTI dataset [here](https://github.com/VBTI-development/onedl-mmdetection3d/blob/master/mmdet3d/core/evaluation/kitti_utils) are only applicable to boxes under Camera coordinate system since the rotation is clockwise if viewed from above.
