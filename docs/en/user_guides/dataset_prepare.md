...
- **Waymo-mini**. If you just want to use a part of Waymo Dataset to verify some methods or debug quickly, you could use our provided [Waymo-mini](https://mmassets.onedl.ai/mmdetection3d/data/waymo_mmdet3d_after_1x4/waymo_mini.tar.gz) which only contains two segments in train split and one segment in val split from the original dataset. All the images, point clouds and annotations in this compressed file have been processed offline so that you can directly download and unzip it to `data/waymo/`:
...
To prepare S3DIS data, please see its [README](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/data/s3dis/README.md).

To prepare ScanNet data, please see its [README](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/data/scannet/README.md).

To prepare SUN RGB-D data, please see its [README](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/data/sunrgbd/README.md).
...
For using custom datasets, please refer to [Customize Datasets](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/docs/en/advanced_guides/customize_dataset.md).
...
| :--------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                                KITTI                                                 |                                                                [kitti_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/kitti/kitti_infos_train.pkl)                                                                |                                                              [kitti_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/kitti/kitti_infos_val.pkl)                                                               |                                                                      [kitti_infos_test](https://mmassets.onedl.ai/mmdetection3d/data/kitti/kitti_infos_test.pkl)                                                                      |
|                                               NuScenes                                               | [nuscenes_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/nuscenes/nuscenes_infos_train.pkl) [nuscenes_mini_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/nuscenes/nuscenes_mini_infos_train.pkl) | [nuscenes_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/nuscenes/nuscenes_infos_val.pkl)  [nuscenes_mini_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/nuscenes/nuscenes_mini_infos_val.pkl) |                                                                                                                                                                                                                                       |
|                                                Waymo                                                 |                                                       [waymo_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/waymo_mmdet3d_after_1x4/waymo_infos_train.pkl)                                                       |                                                     [waymo_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/waymo_mmdet3d_after_1x4/waymo_infos_val.pkl)                                                      | [waymo_infos_test.pkl](https://mmassets.onedl.ai/mmdetection3d/data/waymo/waymo_infos_test.pkl)   [waymo_infos_test_cam_only.pkl](https://mmassets.onedl.ai/mmdetection3d/data/waymo_mmdet3d_after_1x4/waymo_infos_test_cam_only.pkl) |
| [Waymo-mini](https://mmassets.onedl.ai/mmdetection3d/data/waymo_mmdet3d_after_1x4/waymo_mini.tar.gz) |                                                                                                                                                                                                                                 |                                                                                                                                                                                                                          |                                                                                                                                                                                                                                       |
|                                              SUN RGB-D                                               |                                                             [sunrgbd_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/sunrgbd/sunrgbd_infos_train.pkl)                                                             |                                                           [sunrgbd_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/sunrgbd/sunrgbd_infos_val.pkl)                                                            |                                                                                                                                                                                                                                       |
|                                               ScanNet                                                |                                                             [scannet_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/scannet/scannet_infos_train.pkl)                                                             |                                                           [scannet_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/scannet/scannet_infos_val.pkl)                                                            |                                                                 [scannet_infos_test.pkl](https://mmassets.onedl.ai/mmdetection3d/data/scannet/scannet_infos_test.pkl)                                                                 |
|                                            SemanticKitti                                             |                                                    [semantickitti_infos_train.pkl](https://mmassets.onedl.ai/mmdetection3d/data/semantickitti/semantickitti_infos_train.pkl)                                                    |                                                  [semantickitti_infos_val.pkl](https://mmassets.onedl.ai/mmdetection3d/data/semantickitti/semantickitti_infos_val.pkl)                                                   |                                                        [semantickitti_infos_test.pkl](https://mmassets.onedl.ai/mmdetection3d/data/semantickitti/semantickitti_infos_test.pkl)                                                        |
