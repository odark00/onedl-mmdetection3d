...
Please refer to [kitti_converter.py](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/tools/dataset_converters/kitti_converter.py) and [update_infos_to_v2.py ](https://github.com/VBTI-development/onedl-mmdetection3d/blob/main/tools/dataset_converters/update_infos_to_v2.py) for more details.
